    ...
    <Box sx={{ display: 'flex',flexDirection: { xs: 'column', sm: 'row' },  justifyContent: 'space-between' }}>
      ...
      <Box sx={{ minWidth: "16.6%" }}>
        <FormControl fullWidth>
          ...
          <Select labelId="experience-label" value={experience} onChange={(e) => setExperience(e.target.value)}>
      ...
      <Box sx={{ minWidth: "16.6%" }}>
        <FormControl fullWidth>
          ...
          <Select labelId="remote-label" value={remote} onChange={(e) => setRemote(e.target.value)}>
      ...
      <Box sx={{ minWidth: "16.6%" }}>
        <FormControl fullWidth>
          ...
          <Select labelId="salary-label" value={salary} onChange={(e) => setSalary(e.target.value)}>
